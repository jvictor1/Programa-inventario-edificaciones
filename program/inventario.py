...
result_dptos, resumen_dptos, resumen_mpios, result_nedifstr, result_mode, result_nedif = functions.func_principal(ruta_carpetas, deptcod, deptname, filtClase, filtUnidad, filtViv, False, False)
