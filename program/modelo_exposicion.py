...
result_path = r'D:\Universidad\[10]Décimo Semestre\Ingeniería Sísmica\Procesamiento datos del censo\GitHub\program/output_combinacionesSimacota.csv' #ruta a archivo con los resultados de número de edificaciones por combinación
...
exe_subdivi = True #True: se ejecuta a nivel manzana
...
# ut.save_csv(tipologias, "output_Tipologias_disgregadas")
# # Matriz de tipologías por municipio
# ut.save_csv(tiporesumen, "output_Tipologias_Mpios")
# # Matriz de tipologías agregada por # de pisos
# ut.save_csv(tipo_aggregate, "output_TipologiasAgg_Mpios")