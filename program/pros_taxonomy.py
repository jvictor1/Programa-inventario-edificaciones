        ...
        for mpiocod in mpios_dpto['COD']:
            ...
            if mpiocod in exclude:
                ...
                for m, data in mpios_filtered.iterrows():
                            ...
                            if (value == "detailed_1" or value == "detailed_2") and flag == False:
                                ...
                                for j, row in dist_comb.iterrows():
                                    ...
                                    for k in cols:
                                        ...
                                        porcentaje = row[k]
                                        dist_mater = dist_mater.append({"Material Pared": mat_pared, "Material Piso": k, 
                    ...
                    dist_mater_pivot = pd.pivot_table(dist_mater, index=['Material Pared', 'Material Piso', 'Tipo Vivienda'], columns=['Combinación'], values=['Porcentaje']).fillna(0).reset_index()   
